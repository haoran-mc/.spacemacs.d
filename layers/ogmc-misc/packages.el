...
(defun ogmc-misc/post-init-evil ()
  (progn
    ...
    (spacemacs/set-leader-keys "RET" 'spacemacs/evil-search-clear-highlight)

    (spacemacs/set-leader-keys "bi" 'ibuffer)
    (define-key evil-emacs-state-map (kbd "C-w") 'evil-delete-backward-word)
    ))

(defun ogmc-misc/post-init-golden-ratio ()
...
(defun ogmc-misc/post-init-ranger ()
...
(defun ogmc-misc/post-init-markdown-mode ()
  (progn
...
(defun ogmc-misc/post-init-helm ()
