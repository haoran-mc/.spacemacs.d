;;; dracula-theme.el --- imitative write             -*- lexical-binding: t; -*-
...
(let ((colors '(;; Upstream theme color
      ...
      (faces '(;; default
               ...
               (ivy-current-match
                ,@(if dracula-alternate-mode-line-and-minibuffer
                      (list :weight 'normal :foreground dracula-green)
                    (list :weight 'bold :foreground dracula-green)))
               ...
               (web-mode-html-tag-face :foreground ,dracula-pink :weight bold) ;; #8b8989
