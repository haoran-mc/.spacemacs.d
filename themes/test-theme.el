;;; test-theme.el --- test others themes             -*- lexical-binding: t; -*-
...
(let ((class '((class color) (min-colors 89)))
  ...
  ;; Customize color
  (defconst -test-bg                         black-5)
  (defconst -test-fg                         white-1)
  (defconst -test-builtin                    purple-1)
  (defconst -test-comment-delimiter          black-2-5)
  (defconst -test-comment                    black-2-5)
  (defconst -test-constant                   blue-1)
  (defconst -test-doc                        red-0)
  (defconst -test-doc-string                 yellow-3)
  (defconst -test-function-name              yellow-2)
  (defconst -test-keyword                    green-2)
  (defconst -test-negation-char              red-0)
  (defconst -test-preprocessor               purple-1)
  (defconst -test-regexp-grouping-backslash  yellow-1)
  (defconst -test-regexp-grouping-construct  purple-1)
  (defconst -test-string                     magenta-2)
  (defconst -test-type                       cyan-3)
  (defconst -test-variable-name              orange-2)
  (defconst -test-warning                    red-2)

  (defvar test-bg                         -test-bg                       )
  (defvar test-fg                         -test-fg                       )
  (defvar test-builtin                    -test-builtin                  )
  (defvar test-comment-delimiter          -test-comment-delimiter        )
  (defvar test-comment                    -test-comment                  )
  (defvar test-constant                   -test-constant                 )
  (defvar test-doc                        -test-doc                      )
  (defvar test-doc-string                 -test-doc-string               )
  (defvar test-function-name              -test-function-name            )
  (defvar test-keyword                    -test-keyword                  )
  (defvar test-negation-char              -test-negation-char            )
  (defvar test-preprocessor               -test-preprocessor             )
  (defvar test-regexp-grouping-backslash  -test-regexp-grouping-backslash)
  (defvar test-regexp-grouping-construct  -test-regexp-grouping-construct)
  (defvar test-string                     -test-string                   )
  (defvar test-type                       -test-type                     )
  (defvar test-variable-name              -test-variable-name            )
  (defvar test-warning                    -test-warning                  )

  (custom-theme-set-faces
   'test
   ;; Font lock faces
   `(font-lock-builtin-face              ((,class (:background nil :foreground ,test-builtin                  ))))
   `(font-lock-comment-delimiter-face    ((,class (:background nil :foreground ,test-comment-delimiter        :slant italic))))
   `(font-lock-comment-face              ((,class (:background nil :foreground ,test-comment                  :slant italic))))
   `(font-lock-constant-face             ((,class (:background nil :foreground ,test-constant                 ))))
   `(font-lock-doc-face                  ((,class (:background nil :foreground ,test-doc                      ))))
   `(font-lock-doc-string-face           ((,class (:background nil :foreground ,test-doc-string               ))))
   `(font-lock-function-name-face        ((,class (:background nil :foreground ,test-function-name            ))))
   `(font-lock-keyword-face              ((,class (:background nil :foreground ,test-keyword                  ))))
   `(font-lock-negation-char-face        ((,class (:background nil :foreground ,test-negation-char            ))))
   `(font-lock-preprocessor-face         ((,class (:background nil :foreground ,test-preprocessor             ))))
   `(font-lock-regexp-grouping-backslash ((,class (:background nil :foreground ,test-regexp-grouping-backslash))))
   `(font-lock-regexp-grouping-construct ((,class (:background nil :foreground ,test-regexp-grouping-construct))))
   `(font-lock-string-face               ((,class (:background nil :foreground ,test-string                   ))))
   `(font-lock-type-face                 ((,class (:background nil :foreground ,test-type                     ))))
   `(font-lock-variable-name-face        ((,class (:background nil :foreground ,test-variable-name            ))))
   `(font-lock-warning-face              ((,class (:background nil :foreground ,test-warning               :weight bold ))))
   ;; Ensure sufficient contrast on low-color terminals.
   `(default ((((class color) (min-colors 4096)) (:foreground ,test-fg :background ,test-bg))
	      (((class color) (min-colors 256)) (:foreground ,test-fg :background ,test-bg))
	      (,class (:foreground ,test-fg :background ,test-bg))))
